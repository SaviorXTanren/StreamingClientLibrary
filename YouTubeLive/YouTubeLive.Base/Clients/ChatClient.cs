...
namespace YouTubeLive.Base.Clients
{
    /// <summary>
    /// Handles interaction with Live Stream-based chat services.
    /// </summary>
    public class ChatClient : YouTubeLiveServiceBase, IDisposable
    {
        ...
        /// </summary>
        /// <param name="connection">The connection to YouTube Live</param>
        public ChatClient(YouTubeLiveConnection connection) : base(connection) { }
